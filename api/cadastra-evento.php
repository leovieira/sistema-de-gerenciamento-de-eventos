<?php
	...
	and isset($_GET['instituicao']) and isset($_GET['cod_administrador']) and isset($_GET['cod_avaliadores'])) {
		if ($_GET['key']!=null and $_GET['nome']!=null and $_GET['descricao']!=null and $_GET['instituicao']!=null 
		and $_GET['cod_administrador']!=null and $_GET['cod_avaliadores']!=null) {
			if ($_GET['key']==$key) {
				if ($connection) {
					$nome = $_GET['nome'];
					...
					$rs = mysqli_query($connection, "INSERT INTO eventos (nome, descricao, instituicao, cod_administrador, 
					cod_avaliadores) VALUES ('$nome', '$descricao', '$instituicao', $cod_administrador, '$cod_avaliadores');");
