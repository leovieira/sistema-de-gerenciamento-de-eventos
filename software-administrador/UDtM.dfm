object DtM: TDtM
  ...
  object FDConexao: TFDConnection
    Params.Strings = (
        ...
        'Database=C:\Users\Leonardo Paiva\Desktop\SGE\software-administra' +
        'dor\db\sge.s3db'
      'LockingMode=Normal'
      'DriverID=SQLite')
    Connected = True
  ...
  object FDQryUpdateAdmin: TFDQuery
    Connection = FDConexao
    SQL.Strings = (
      
        'UPDATE administrador set nome=:nome, usuario=:usuario, senha=:se' +
        'nha WHERE cod_administrador=:cod_administrador;')
    Left = 64
    Top = 256
    ParamData = <
      item
