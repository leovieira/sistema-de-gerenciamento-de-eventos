...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Dez-2019 às 17:45
...
CREATE TABLE `votantes` (
  `cod_votante` int(11) NOT NULL,
  `hash` varchar(4) NOT NULL,
  `cod_evento` int(11) NOT NULL,
  `votado` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Tabela de "Votantes"';
...
--
ALTER TABLE `equipes`
  MODIFY `cod_equipe` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `votantes`
  MODIFY `cod_votante` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
